...
def QuadMagBeaconator(QuadMag, BeacFreq):
...
# BeacFreq = 1/2
# QuadMag.setCollectionTime(20)
# #RunQuadMag(QuadMag,"TEST")
# print(QuadMagBeaconator(QuadMag, BeacFreq))